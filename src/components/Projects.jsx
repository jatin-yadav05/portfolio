...
const Projects = () => {
  ...
  const projects = [
    ...
    {
      title: "Snakk Food App",
      description: "A food app design for seamless ordering and delivery in hostels.",
      tech: ["Figma", "UI/UX Design", "Prototyping"],
      image: "/projectimages/snakk-app.png",
      year: "2025",
      link: "https://www.figma.com/design/Kc6TSLJe8dfWfIWSO5DE83/Snakk?node-id=0-1&t=qeQ689LBhjwYuBkx-1",
    },
    {
      title: "Home Page Redesign Sendfame.com",
      description: "Create in seconds with the top AI music generator, celebrity video messages, AI images, and more Effortless viral content with AI.",
      tech: ["Figma", "Home Page Design", "User Research"],
      image: "/projectimages/sendfame-home.png",
      year: "2025",
      link: "https://www.figma.com/design/khO2wVMl5OfkEo4cTJX3hp/Sendfame?node-id=0-1&t=LLQ1CkAsEsvchw25-1",
    },
    {
      title: "Mental Health CaseStudy",
      description: "Clean and professional mental health platform design focused on user research and inclusivity.",
      tech: ["Figma", "SaaS Design", "User Research"],
      image: "/projectimages/soulside-casestudy.png",
      year: "2025",
      link: "https://www.figma.com/design/ZtCVzgdCUNSxj6UaA8DIbo/SoulSide-Case-Study?node-id=0-1&t=F5rl1aVlC5VTS46V-1",
    }
  ];
